...
import 'package:practo_doctor/bottompages/chat/chat_room/past_chat_room.dart';

class PastChat extends StatefulWidget {
  ...
  @override
  State<PastChat> createState() => _PastChatState();
}

class _PastChatState extends State<PastChat> {
  @override
